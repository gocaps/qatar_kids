...
define('BRAZIL_OUT', 1);		define('ARGENTINA_OUT', 0); define('FRANCE_OUT', 1);
...
define('ENGLAND_WINS', 9);		define('ENGLAND_TIES', 1);		define('ENGLAND_BONUS', 3);
define('HOLLAND_WINS', 9);    define('HOLLAND_TIES', 1);    define('HOLLAND_BONUS', 3);
define('SPAIN_OUT', 1);			define('ENGLAND_OUT', 1);   define('HOLLAND_OUT', 1);
...
define('GERMANY_OUT', 1);  define('PORTUGAL_OUT', 1);define('BELGIUM_OUT', 1);
...
define('SENEGAL_WINS', 6);		define('SENEGAL_TIES', 0);		define('SENEGAL_BONUS', 3);
define('USA_WINS', 3);		define('USA_TIES', 2);		define('USA_BONUS', 0);
define('SERBIA_WINS', 0);		define('SERBIA_TIES', 1);		define('SERBIA_BONUS', 0);
define('POLAND_OUT', 1);			define('SENEGAL_OUT', 1);			define('USA_OUT', 1);	define('SERBIA_OUT', 1);
...
define('AUSTRALIA_OUT', 1);		define('CAMEROON_OUT', 1);			define('IRAN_OUT', 1);
...
/*************************************************/
//J
define('TUNISIA_WINS', 3);	define('TUNISIA_TIES', 1);	define('TUNISIA_BONUS', 3);
...
define('TUNISIA_OUT', 1);		define('QATAR_OUT', 1);			define('SAUDI_OUT', 1);		define('COSTA_OUT', 1);
...
/*************************************************/
//K
define('MBAPPE_GOALS', 16);    define('MBAPPE_BONUS', 3);
define('MESSI_GOALS', 14);   define('MESSI_BONUS', 0);
define('KANE_GOALS', 2);   define('KANE_BONUS', 0);
define('MBAPPE_OUT', 1);	 define('MESSI_OUT', 0); define('KANE_OUT', 1);
...
/*************************************************/
//L
define('NEYMAR_GOALS', 4);		define('NEYMAR_BONUS', 3);
define('BENZEMA_GOALS', 0);		define('BENZEMA_BONUS', 0);
define('RONALDO_GOALS', 2);		define('RONALDO_BONUS', 0);
define('NEYMAR_OUT', 1);		define('BENZEMA_OUT', 1);		define('RONALDO_OUT', 1);
...
define('DEPAY_GOALS', 2);		define('DEPAY_BONUS', 3);
define('VINI_GOALS', 2);		define('VINI_BONUS', 3);
define('LUKAKU_OUT', 1);		define('LAUTARO_OUT', 0);		define('DEPAY_OUT', 1);		define('VINI_OUT', 1);
...
/*************************************************/
//N
define('RICHARLISON_GOALS', 6);		define('RICHARLISON_BONUS', 3);
define('MORATA_GOALS', 6);		define('MORATA_BONUS', 3);
define('HAVERTZ_GOALS', 4);		define('HAVERTZ_BONUS', 0);
define('LEWANDOWSKI_GOALS', 4);		define('LEWANDOWSKI_BONUS', 0);
define('RICHARLISON_OUT', 1);			define('MORATA_OUT', 1);		define('HAVERTZ_OUT', 1);		define('LEWANDOWSKI_OUT', 1);
...
define('GNABRY_GOALS', 2);	define('GNABRY_BONUS', 0);
define('GRIEZMANN_GOALS', 0);		define('GRIEZMANN_BONUS', 0);
define('TORRES_OUT', 1);		define('STERLING_OUT', 1);		define('GNABRY_OUT', 1);		define('GRIEZMANN_OUT', 1);
...
define('FODEN_GOALS', 2);		define('FODEN_BONUS', 3);
define('DEBRUYNE_GOALS', 0);		define('DEBRUYNE_BONUS', 0);
define('NUNEZ_GOALS', 0);		define('NUNEZ_BONUS', 0);
define('FATI_OUT', 1);		define('FODEN_OUT', 1);		define('DEBRUYNE_OUT', 1);		define('NUNEZ_OUT', 1);
...
define('VLAHOVIC_OUT', 1);	define('SANE_OUT', 1);		define('BALE_OUT', 1);		define('GAKPO_OUT', 1);
...
/*************************************************/
//T
define('DAVIES_GOALS', 2);		define('DAVIES_BONUS', 3);
...
define('DAVIES_OUT', 1);		define('LARIN_OUT', 1);		define('BUCHANON_OUT', 1);		define('CAVALLINI_OUT', 1);  define('DAVID_OUT', 1);
